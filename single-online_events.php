                   ...
                   <h3>Speaker:</h3>
	                ...
	                <div class="row">
                        ...
                        <div class="speaker-img">
                           <img src="<?php echo the_field('event_speaker_1_image'); ?>" alt="<?php echo the_title(); ?>" />
                        </div>    
	                <div class="speaker-name">
	                    <h4><?php the_field('speaker_name_1'); ?></h4>
	                </div>
                        </div>
	                    </div>
                        ...
                        <div class="speaker-item">
                        <div class="speaker-img">
                           <img src="<?php echo the_field('event_speaker_2_image'); ?>" alt="<?php echo the_title(); ?>" />
                        </div>    
	                <div class="speaker-name">
	                    <h4><?php the_field('speaker_name_2'); ?></h4>
	                </div>
                        </div>
	                    </div>
                        ...
                        <div class="speaker-item">
                        <div class="speaker-img">
                           <img src="<?php echo the_field('event_speaker_3_image'); ?>" alt="<?php echo the_title(); ?>" />
                        </div>    
	                <div class="speaker-name">
	                    <h4><?php the_field('speaker_name_3'); ?></h4>
	                </div>
                        </div>
	                    </div>
                ...
                <div class="sub-title">
                   <h3>Link</h3>
                    ...
                    <div class="meet-button">
                         <a href="<?php echo the_field('event_link'); ?>"><button class="link-button">Click on the button to enter your meeting room></button></a>
                    </div>
...
?></div>
         ...
         <!--  <div class="sub-title">
           ...
           <p><?php the_field('event_start_date_and_time'); ?></p>
           
           <div class="sub-title">
                   <h3>Event end date:</h3>
           </div>
           <p><?php the_field('event_end_date_and_time'); ?></p>
      ...
      <div class="comment-area">
          ...
          <!-- <div class="sub-title">
           ...
           <div title="Add to Calendar" class="addeventatc">
               Add to Calendar
              <span class="start"><?php the_field('event_start_date_and_time'); ?></span>
              <span class="end"><?php the_field('event_end_date_and_time'); ?></span>
      ...
      <div class="card-body">
	    ...
	    <center>
           ...
           <div class="social-icons">
             ...
             <a href="<?php echo the_field('twiter'); ?>" class="twitter"><i class="fa fa-twitter"></i></a>
